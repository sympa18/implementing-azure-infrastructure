...
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamemel -TemplateFile .\2\contosoObjects.json -TemplateParameterObject $MELParams -Verbose
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamesyd -TemplateFile .\2\contosoObjects.json -TemplateParameterObject $SYDParams -Verbose 
