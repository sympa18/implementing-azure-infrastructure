...
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamemel -TemplateFile .\4\contosoObjects.json -TemplateParameterObject $MELParams -Verbose
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamesyd -TemplateFile .\4\contosoObjects.json -TemplateParameterObject $SYDParams -Verbose 
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamemel -TemplateFile .\4\trafficmanager.json -TemplateParameterObject $TrafficManagerParams -Verbose
